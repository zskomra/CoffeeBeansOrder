...
const DEFAULT_MIN_AMOUNT_TO_ORDER = 5;
const Cart = (props) => {
  ...
  const cartMinValue = totalAmount > DEFAULT_MIN_AMOUNT_TO_ORDER;
  ...
  const orderItems = (
    <Fragment>
      ...
      <div className={classes.actions}>
        ...
        <button disabled={!cartMinValue}  onClick={isLogged ? onCheckoutHanlder : props.onAuth} className={classes.button}>
          Order
        </button>
      </div>
    </Fragment>
